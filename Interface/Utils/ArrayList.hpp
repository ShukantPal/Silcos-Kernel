 ...
 * @author Shukant Pal
 */
class ArrayList final : virtual public Object
{
public:
	ArrayList();
	...
	Object *fastGet(unsigned long idx){ return (elemData[idx]); }
	...
	void set(Object *elem, unsigned long idx);
	...
	{
	public:
		Iterator(ArrayList& list) : list(list)
		{
