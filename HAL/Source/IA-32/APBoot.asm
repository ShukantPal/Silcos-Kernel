...
SECTION .text
		...
		ADM_PADDR_HAL_LOAD_ADDR					equ		(ADM_PADDR_TRAMPOLINE + halLoadAddr - APBoot)
		ADM_PADDR_HAL_LOAD_PADDR				equ		(ADM_PADDR_TRAMPOLINE + halLoadPAddr - APBoot)
		...
		MOV DWORD EBX, ADM_PADDR_APMAIN32 ; AP_MAIN32_INVOKER comes here
